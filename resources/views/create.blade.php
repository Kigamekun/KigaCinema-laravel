...
<form method="POST" action="{{ route('store') }}" class="w-full max-w-lg" enctype="multipart/form-data">
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3">
        ...
        <input name="title" class="appearance-none block w-full bg-white-200 text-white-700 border border-white-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-white-500" id="grid-password" type="text" placeholder="Fill The Title">
    ...
    <div class="flex flex-wrap -mx-3 mb-2">
      ...
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <div class="relative">
          <select id="country" name="country" class="block appearance-none w-full bg-white-200 border border-white-200 text-white-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-white-500" id="grid-state">
            <option>Japan</option>
            <option>USA</option>
      ...
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <input name="price" class="appearance-none block w-full bg-white-200 text-white-700 border border-white-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-white-500" id="grid-city" type="text" placeholder="20000">
      </div>
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        <label class="block uppercase tracking-wide text-white-700 text-xs font-bold mb-2" for="grid-zip">
          On Air
        </label>
        <input name="on_air" class="appearance-none block w-full bg-white-200 text-white-700 border border-white-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-white-500" id="grid-zip" type="text" placeholder="1 , 2 , 3">
      </div>
    </div>
