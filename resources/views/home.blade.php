    ...
    <header class="text-white md:flex md:items-center md:justify-between p-4 pb-0 shadow-lg md:pb-4 ">
        ...
        <nav>
            <ul class="list-reset md:flex md:items-center">
                @if (Auth::guest())
                    <li class="md:ml-4">
                        <a class="block no-underline hover:bold py-2 text-grey-darkest hover:text-purple-700 md:border-none md:p-0"
                            href="{{ route('login') }}">
                            Login
                        </a>
                    </li>
                    <li class="md:ml-4">
                        <a class="border-t block no-underline hover:bold py-2 text-grey-darkest hover:text-purple-700 md:border-none md:p-0"
                            href="{{ route('register') }}">
                            Register
                        </a>
                    </li>
      ...
      this.closest('form').submit();"
                                class="border-t block no-underline hover:bold py-2 text-grey-darkest hover:text-purple-700 md:border-none md:p-0"
                                href="{{ route('logout') }}">
                                Logout
                            </a>
                        ...
                        <div class="">
                            <div class="relative h-62 w-full mb-3">
                                <div class="absolute flex flex-col top-0 right-0 p-3">
                                    <button data-movie="{{ $item->id }}"
                                        class="bookmark transition ease-in duration-300 bg-gray-800  hover:text-purple-500 shadow hover:shadow-md text-gray-500 rounded-full w-8 h-8 text-center p-1">
                                ...
                                <img src="{{ url('/thumb_mov' . '/' . $item->thumb) }}" alt="Just a flower"
                                ...
                                <div class="flex flex-wrap ">
                                    <div class="w-full flex-none text-sm flex items-center text-gray-600">
                                        ...
                                        <span class="text-gray-400 whitespace-nowrap mr-3">4.60</span><span
                                            class="mr-2 text-gray-400">{{ $item->country }}</span>
                                    </div>
